...
import { IconAsterisk, IconTicket } from '@tabler/icons-react';
        ...
        <div className=' w-full flex flex-col px-10 2xl:px-[10%]'>
            ...
            >
                ...
                <div className="flex gap-2 m-auto">
                    <Button color="primary" variant='shadow' className='font-semibold text-lg px-10' endContent={<IconTicket stroke={2} />}  onClick={() => {
                        addToast({
                            title: "Compra realizada con éxito",
                            description: "Dentro de las próximas 12 hs, soporte se contactará contigo",
                            color: "success",
